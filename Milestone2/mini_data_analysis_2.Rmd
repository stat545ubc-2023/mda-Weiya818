...
glimpse(vancouver_trees)
```
However, based on the results, the vancouver_trees dataset contains missing values in certain columns if we track it with is.na() function, so it is untidy.
